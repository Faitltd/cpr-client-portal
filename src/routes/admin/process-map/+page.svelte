	...
	const PHASES = [
		{
			...
			steps: [
				...
				{ code: "DC", name: "Discovery Call Booked", pct: "", type: "Standard", outcomes: [],
					automations: ["Bookings > Flow > CRM: status auto-updated", "HWWWY Email auto-sent (WF #15)", "Notify Jeff via Cliq on discovery call (WF #26)", "Blueprint reminder sequence initiated"] },
				...
				{ code: "SB", name: "Site Visit Booked", pct: "", type: "Standard", outcomes: [],
					automations: ["Bookings > Flow > CRM: status auto-updated", "Site Visit Booked Email auto-sent (WF #19)", "Site Visit Update: field update on meeting (WF #17)"] },
